...
class Sistema 
{
    ...
    void cargarPasajerosDesdeArchivo(const string& nombreArchivo);
    //////////////////////////////////////////
    ...
    void cargarReservasDesdeArchivo(const string& nombreArchivo);
    ...
    void cargarVuelosDesdeArchivo(const string& nombreArchivo);
};
